            ...
            <div class="article-preview" v-for="(article, index) in feed.articles" :key="index">
                <div class="article-meta">
                    ...
                    <div class="pull-xs-right">
                        <mcv-favorites :is-favorited="article.favorited" :article-slug="article.slug" :article-count="article.favoritesCount"/>
                    </div>
                </div>
                <router-link :to="{name: 'article', params: {slug: article.slug}}" class="preview-link">
                    ...
                    <span>Read more...</span>
                    <mcv-tag-list v-if="article.tagList.length > 0" :tags="article.tagList"/>
                </router-link>
            </div>
...
<script>
    ...
    import McvFavorites from '@/components/Favorites'
    ...
    export default {
        ...
        computed: {
            ...
            offset(){
                return this.currentPage * limit - 10
            }
        },
        watch: {
            currentPage(){
